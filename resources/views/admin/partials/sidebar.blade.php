...
<div class="w-44 h-full flex flex-col items-center bg-[#FA6601] border-r border-gray-200 dark:bg-gray-900 dark:border-gray-700 text-white font-medium">
    <div class="h-full py-2 overflow-y-auto w-full bg-[#FA6601] dark:bg-gray-800 text-xs flex justify-center ">
       <ul class="space-y-1  dark:border-gray-700 w-40 ">
        ...
        <li>
         @if ($title == 'Jurusan')
            <a href="/admin/jurusan" class="flex  items-center p-2 text-[#FA6601] rounded-lg dark:text-white bg-white dark:bg-gray-700 group ">
               <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" fill="currentColor" class="bi bi-person-workspace" viewBox="0 0 16 16">
                  <path d="M4 16s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-5.95a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/>
                  <path d="M2 1a2 2 0 0 0-2 2v9.5A1.5 1.5 0 0 0 1.5 14h.653a5.4 5.4 0 0 1 1.066-2H1V3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v9h-2.219c.554.654.89 1.373 1.066 2h.653a1.5 1.5 0 0 0 1.5-1.5V3a2 2 0 0 0-2-2z"/>
                </svg>
               <span class="ms-2">Jurusan</span>
            </a>
         @else
            <a href="/admin/jurusan" class="flex  items-center p-2 hover:text-[#FA6601] rounded-lg dark:text-white hover:bg-white dark:hover:bg-gray-700 group ">
               <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" fill="currentColor" class="bi bi-person-workspace" viewBox="0 0 16 16">
                  <path d="M4 16s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1zm4-5.95a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5"/>
                  <path d="M2 1a2 2 0 0 0-2 2v9.5A1.5 1.5 0 0 0 1.5 14h.653a5.4 5.4 0 0 1 1.066-2H1V3a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v9h-2.219c.554.654.89 1.373 1.066 2h.653a1.5 1.5 0 0 0 1.5-1.5V3a2 2 0 0 0-2-2z"/>
                </svg>
